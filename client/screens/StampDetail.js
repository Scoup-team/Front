...
const StampDetail = ({ navigation, stampId }) => {
      ...
      <View style={styles.storeSection}>
        ...
        <ScrollView>
          ...
          <View style={styles.sectionName}>
            ...
            <Text style={styles.storeName}>{getDetailData.cafeName}</Text>
          </View>
          ...
          <View style={styles.orderSection}>
            ...
            <View style={styles.orderMenuSection}>
              <View style={styles.orderMenu}>
                <Text style={styles.orderText}>
                  {getDetailData.menu[0].name}
                </Text>
                <Text style={styles.orderText}>
                  {getDetailData.menu[0].price}
                </Text>
              </View>
              <View style={styles.orderMenu}>
                <Text style={styles.orderText}>
                  {getDetailData.menu[1].name}
                </Text>
                <Text style={styles.orderText}>
                  {getDetailData.menu[1].price}
                </Text>
              </View>
            </View>
            {/* 결제 카드 정보 */}
            ...
            <View style={styles.cardSection}>
              <View style={styles.card}>
                ...
                <Text style={styles.orderText}>{getDetailData.cardName}</Text>
              </View>
              <View style={styles.card}>
                <Text style={styles.orderText}>카드 번호</Text>
                <Text style={styles.orderText}>{getDetailData.cardNum}</Text>
              </View>
            </View>
          </View>
